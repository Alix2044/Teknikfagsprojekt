...
function setup(){
  ...
  næste = createDiv("<a style='text-decoration:none' href='/Formelsamling/Sider/divi.html'>Division</a>");
  forrige = createDiv("<a style='text-decoration:none' href='/Formelsamling/Sider/plus_minus.html'>Plus og Minus</a>");
...
function knapper(){
  ...
  forrige.position(forrigeKnapX - næsteKnapWidth / 2.3, næsteKnapY - (næsteKnapHeight) / 2.5);
